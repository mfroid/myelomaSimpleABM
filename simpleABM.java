...
class simpleBoneCell extends AgentSQ2Dunstackable<simpleBoneGrid> {
    ...
    boolean encounteredMyeloma = false;
    ...
    public void CellStep(int time, double [] Cell_Counts, int simID) {
        ...
        if (type == MM) {
            ...
            double x = ProbScale(1.5e-4, TIMESTEP_AGENT);
            ...
            pdiv = ProbScale((1.0 / 1440) * scaleFactor, MinToHour);
            ///////////
            //MM dies//
            ///////////
